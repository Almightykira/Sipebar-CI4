...
<?= session()->getFlashdata('sukses'); ?>
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-4">
      <input type="number" class="form-control" id="brgharga" name="brgharga" value="<?= $harga; ?>">
    </div>
  </div>
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-4">
      <input type="number" class="form-control" id="brgstok" name="brgstok" value="<?= $stok; ?>">
    </div>
  </div>
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-4">
        <img src="<?= base_url() . '/' . $gambar ?>" class="img-thumbnail" style="width: 50%;">
    </div>
  </div>

  <div class="form-group row">
    <label for="" class="col-sm-4 col-form-label">Upload Gambar (<i>jika ingin diganti....</i>)</label>
    <div class="col-sm-4">
