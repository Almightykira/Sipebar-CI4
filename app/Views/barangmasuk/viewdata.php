...
<div class="input-group mb-3">
  <input type="text" class="form-control" placeholder="Cari Berdasarkan Faktur...." name="cari" value="<?=$cari ?>" autofoucus="true">
  <div class="input-group-append">
    <button class="btn btn-outline-primary" type="submit" name="tombol">
        <i class="fa fa-search"></i>
    </button>
  </div>
</div>
<?= form_close(); ?>
<table class="table table-sm table-bordered tabel-hover">
    <thead>
        <tr>
            <th>No</th>
            <th>Faktur</th>
    ...
    <?php
        ...
        <tr>
            ...
            <td>
                <button type="nutton" class="btn btn-sm btn-outline-info" title="Edit Transaksi" onclick="edit('<?= ($row['faktur']) ?>')" >
                    <i class="fa fa-edit"></i>
                </button>
                <button type="nutton" class="btn btn-sm btn-outline-danger" title="Hapus Transaksi" onclick="hapusTransaksi('<?= ($row['faktur']) ?>')" >
...
<script>
    function hapusTransaksi(faktur){
        ...
        text: "Apakah Anda Yakin Menghapus Transaksi Ini?",
        icon: 'warning',
