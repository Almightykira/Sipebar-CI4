...
<table class="table table-sm table-striped table-hover" style="width: 100%">
    <tr>
        ...
        <td rowspan="3" style="vertical-align: middle; tet-align: middle; text-align: center; font-weight: bold; font-size:25pt" 
        id="totalHarga">
    ...
    $('#tombolTambahItem').click(function (e) {
        ...
        if (faktur.length == 0) {
            Swal.fire({
                icon: 'error',
                title: 'Oops...',
                text: 'Maaf, kode faktur wajib diisi'
            })
