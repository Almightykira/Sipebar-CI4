  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="staticBackdropLabel">Form Input Tambah Apotek</h5>
      ...
      <div class="modal-body">
        ...
        <div class="form-group">
          <label for="">input Nama Apotek</label>
      ...
      $('.formsimpan').submit(function (e) {
        ...
        $.ajax({
          ...
          beforeSend: function () {
            ...
            $('#tombolsimpan').html('<i class="fa fa-spin fa-spinner">')
          },
          complete: function () {
            ...
            if (response.sukses) {
              Swal.fire({
                ...
                if (result.isConfirmed) {
                  ...
                  $('#idpelanggan').val(response.namapelanggan);
