...
class Barang extends BaseController
{
    ...
    public function index()
    {
        ...
        $totaldata = $cari ? $this->barang->tampildata_cari($cari)->countAllResults() : 
        $this->barang->tampildata()->countAllResults();

        $dataBarang = $cari ? $this->barang->tampildata_cari($cari)->paginate(5, 'barang') : 
        $this->barang->tampildata()->paginate(5, 'barang');
    ...
    public function simpandata(){
        ...
        $harga = $this->request->getVar('brgharga');
        $stok = $this->request->getVar('brgstok');
        ...
        $valid = $this->validate([
            ...
            'gambar' => [
                'rules' => 'mime_in[gambar,image/png,image/jpeg]|ext_in[gambar,png,jpg,gif,jpeg]',
                'label' => 'Gambar',
            ] 
